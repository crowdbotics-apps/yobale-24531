"""yobale_24531 URL Configuration
...
admin.site.site_header = "Yobale"
admin.site.site_title = "Yobale Admin Portal"
admin.site.index_title = "Yobale Admin"

# swagger
api_info = openapi.Info(
    title="Yobale API",
    default_version="v1",
    description="API documentation for Yobale App",
)
